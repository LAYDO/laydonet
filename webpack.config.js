...
module.exports = {
    entry: {
        ...
        sports: [
            ...
            './static/sports/js/SportsWidgets.ts',
            './static/sports/js/team.ts',
            './static/sports/js/TeamPage.ts',
            './static/sports/js/TeamHeader.ts',
            './static/sports/js/TeamBody.ts',
            './static/sports/js/TeamEvent.ts',
            './static/sports/js/TeamSeasonResults.ts',
            './static/sports/js/TeamStandings.ts',
            './static/sports/js/TeamSchedule.ts',
        ],
    },
    mode: 'development',
    cache: false,
