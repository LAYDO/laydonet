...
import { initF1Page, initPgaLeaderboardPage, initSportsLanding, initSportsTeamPage } from "../lib/client/sports";
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  void initF1Page(document.getElementById("sports-f1-root"));
});
