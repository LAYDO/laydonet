...
ALLOWED_HOSTS = os.getenv("DJANGO_ALLOWED_HOSTS",'127.0.0.1,localhost,laydo.net, https://www.laydo.net').split(',')

CSRF_TRUSTED_ORIGINS = ['https://www.laydo.net, https://laydo.net']
